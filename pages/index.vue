  ...
  >
    <div class="hero-body">
      <div class="container center">
        <img
          class="img-responsive px-6 pt-6"
          src="~/assets/sarumen_jacket.jpg"
        />
        <img
          class="img-responsive px-6"
          src="~/assets/sarumen_logo_white.png"
        />
    ...
    <div class="hero-body">
      <div class="container">
        <img class="img-responsive px-6 pt-6" src="~/assets/index2.jpg" />
      </div>
    </div>
  </section>
</template>
